...
public class RequestParser {
    ...
    /**
     * Constructs a RequestParser object to parse the given JSON-formatted request message.
     *
     * @param messageFromClient The JSON-formatted request message from the client.
     * @throws JsonProcessingException If there is an error processing JSON data.
     */
    public RequestParser(String messageFromClient) throws JsonProcessingException {
